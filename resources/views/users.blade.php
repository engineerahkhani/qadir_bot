...
@section('section')
    <div class="row">
        ...
        <div class="col-xs-6 ">
            ...
            <form action={{url('https://modernlifecomputer.com/setactive')}} method="post" role="form">
                {{csrf_field()}}
                <div class="col-xs-6">
    ...
    <div class="row">
        ...
        <div class="col-xs-6">
            <form action={{url('https://modernlifecomputer.com/competition')}} method="post" role="form">
                {{csrf_field()}}
        ...
        <div class="col-xs-6">
            <form action={{url('https://modernlifecomputer.com/message')}} method="post" role="form">
                {{csrf_field()}}
